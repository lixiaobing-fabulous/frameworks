...
import com.lxb.extension.listener.ExtensionListener;
import com.lxb.extension.listener.LoaderEvent;
import com.lxb.extension.spi.SpiLoader;
import com.lxb.extension.ExtensionMeta.AscendingComparator;
...
public abstract class ExtensionManager {
    ...
    public static <T, M> T getOrLoadExtension(final Class<T> extensible, final M name) {
        ExtensionPoint<T, M> spi = SNAPSHOT.getOrLoadExtensionPoint(extensible, null, ExtensionMeta.AscendingComparator.INSTANCE, null);
        return spi == null ? null : spi.get(name);
    }
